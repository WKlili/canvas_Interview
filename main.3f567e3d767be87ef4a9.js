...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _shape_scaleCanvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shape/scaleCanvas */ \"./shape/scaleCanvas.ts\");\n/* harmony import */ var _shape_circle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shape/circle */ \"./shape/circle.ts\");\n/* harmony import */ var _shape_bezier__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shape/bezier */ \"./shape/bezier.ts\");\n/* harmony import */ var _shape_label__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shape/label */ \"./shape/label.ts\");\n\n\n\n\nvar canvas = document.getElementById('canvas');\nvar ctx = canvas.getContext('2d');\n//渐变背景\nvar ratio = Object(_shape_scaleCanvas__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(ctx, canvas);\ndrawBk();\nfunction drawBk() {\n    ctx.beginPath();\n    var linear = ctx.createLinearGradient(0, 0, 512, 0);\n    linear.addColorStop(0, '#ffffff');\n    linear.addColorStop(1, '#000000');\n    ctx.fillStyle = linear;\n    ctx.fillRect(0, 0, 512 * ratio, 512 * ratio);\n    ctx.fillStyle = '#000000';\n    ctx.closePath();\n}\nvar canvasInfo = canvas.getBoundingClientRect();\nvar renderList = [];\nvar addEvent = function () {\n    var startX, startY, choosedIndex = -1;\n    canvas.addEventListener('mousedown', function (e) {\n        startX = e.clientX * ratio;\n        startY = e.clientY * ratio;\n        var ifhave = renderList.map(function (it, index) {\n            it.painting();\n            if (ctx.isPointInPath(startX, startY) && it.drag === true) {\n                choosedIndex = index;\n                return true;\n            }\n            return false;\n        });\n        if (!ifhave.includes(true)) {\n            choosedIndex = -1;\n        }\n        if (choosedIndex !== -1) {\n            itemToLast(choosedIndex);\n        }\n        var target = renderList[renderList.length - 1];\n        if (target.type === 'label') {\n            var word = prompt('请输入注释内容', '');\n            if (word) {\n                target.editLable(word);\n            }\n        }\n        document.addEventListener('dblclick', mouseDblclick);\n        document.addEventListener('mousemove', mousemoveEvent);\n        document.addEventListener('mouseup', mouseupEvent);\n        painting();\n    });\n    function itemToLast(index) {\n        var lastItem = renderList.splice(index, 1)[0];\n        renderList.push(lastItem);\n    }\n    function mouseDblclick() {\n        var target = renderList[renderList.length - 1];\n        if (target.type !== 'bezier') {\n            var word = prompt('请输入注释内容', '');\n            if (word) {\n                target.label.label = word;\n            }\n        }\n        painting();\n    }\n    function mousemoveEvent(e) {\n        if (choosedIndex === -1)\n            return;\n        var target = renderList[renderList.length - 1];\n        var currentX = e.clientX;\n        var currentY = e.clientY;\n        target.adjust(currentX, currentY);\n        startX = currentX;\n        startY = currentY;\n        if (target.type === 'start') {\n            bezierLine.adjustStart(startX, startY);\n        }\n        else if (target.type === 'end') {\n            bezierLine.adjustEnd(startX, startY);\n        }\n        else if (target.type === 'c1') {\n            bezierLine.adjustC1(startX, startY);\n        }\n        else if (target.type === 'c2') {\n            bezierLine.adjustC2(startX, startY);\n        }\n        painting();\n    }\n    function mouseupEvent(e) {\n        if (choosedIndex === -1)\n            return;\n        var target = renderList[renderList.length - 1];\n        var currentX = e.clientX;\n        var currentY = e.clientY;\n        target.adjust(currentX, currentY);\n        startX = currentX;\n        startY = currentY;\n        painting();\n        document.removeEventListener('mousemove', mousemoveEvent);\n        document.removeEventListener('mouseup', mouseupEvent);\n    }\n};\naddEvent();\nvar point1 = [100, 100];\nvar label1 = new _shape_label__WEBPACK_IMPORTED_MODULE_3__[\"default\"](ctx, {\n    center: point1,\n    label: 'start'\n});\nvar circle1 = new _shape_circle__WEBPACK_IMPORTED_MODULE_1__[\"default\"](ctx, {\n    center: point1,\n    radius: 5,\n    type: 'start',\n    label: label1,\n    ratio: ratio\n});\nvar point2 = [300, 300];\nvar label2 = new _shape_label__WEBPACK_IMPORTED_MODULE_3__[\"default\"](ctx, {\n    center: point2,\n    label: 'end'\n});\nvar circle2 = new _shape_circle__WEBPACK_IMPORTED_MODULE_1__[\"default\"](ctx, {\n    center: point2,\n    radius: 5,\n    type: 'end',\n    label: label2,\n    ratio: ratio\n});\nvar c1point = [100, 300];\nvar label3 = new _shape_label__WEBPACK_IMPORTED_MODULE_3__[\"default\"](ctx, {\n    center: c1point\n});\nvar c1 = new _shape_circle__WEBPACK_IMPORTED_MODULE_1__[\"default\"](ctx, {\n    center: c1point,\n    radius: 5,\n    type: 'c1',\n    label: label3,\n    ratio: ratio\n});\nvar c2point = [300, 100];\nvar label4 = new _shape_label__WEBPACK_IMPORTED_MODULE_3__[\"default\"](ctx, {\n    center: c2point\n});\nvar c2 = new _shape_circle__WEBPACK_IMPORTED_MODULE_1__[\"default\"](ctx, {\n    center: c2point,\n    radius: 5,\n    type: 'c2',\n    label: label4,\n    ratio: ratio\n});\nvar bezierLine = new _shape_bezier__WEBPACK_IMPORTED_MODULE_2__[\"default\"](ctx, {\n    startx: point1[0],\n    starty: point1[1],\n    endx: point2[0],\n    endy: point2[1],\n    c1x: c1point[0],\n    c1y: c1point[1],\n    c2x: c2point[0],\n    c2y: c2point[1]\n});\nArray.prototype.push.apply(renderList, [\n    label1,\n    label2,\n    label3,\n    label4,\n    circle1,\n    circle2,\n    c1,\n    c2,\n    bezierLine\n]);\nvar painting = function () {\n    ctx.clearRect(0, 0, canvasInfo.width, canvasInfo.height);\n    drawBk();\n    renderList.forEach(function (it) {\n        it.painting();\n    });\n};\ncanvas.addEventListener('click', function (e) { });\n\n\n//# sourceURL=webpack:///./index.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return scaleCanvas; });\nfunction scaleCanvas(ctx, canvas) {\n    var devicePixelRatio = window.devicePixelRatio || 1, backingStoreRatio = ctx.webkitBackingStorePixelRatio ||\n        ctx.mozBackingStorePixelRatio ||\n        ctx.msBackingStorePixelRatio ||\n        ctx.oBackingStorePixelRatio ||\n        ctx.backingStorePixelRatio ||\n        1, ratio = devicePixelRatio / backingStoreRatio;\n    var oldWidth = canvas.width;\n    var oldHeight = canvas.height;\n    canvas.width = oldWidth * ratio;\n    canvas.height = oldHeight * ratio;\n    canvas.style.width = oldWidth + 'px';\n    canvas.style.height = oldHeight + 'px';\n    ctx.scale(ratio, ratio);\n    return ratio;\n}\n\n\n//# sourceURL=webpack:///./shape/scaleCanvas.ts?");
